...
series at 5, 10, 20, and 40 ms. Dark frames expose fixed readout structure,
amplifier glow, and defects; flat frames expose a uniform illuminated field
with vignetting, dust shadows, PRNU, and shot noise. No expected result is
precomputed in the file; the visible quickstart path exercises the production
workflow.
